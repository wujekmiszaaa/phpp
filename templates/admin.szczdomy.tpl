...
<table> 
{foreach from=$domy item=domyp name=ofertadomu}
<tr>
        ...
        <tr>
            ...
            <td>     </td>
            <td>Dzialka: {$domyp.powierzchnia_dzialki} m^2</td>
            <td>     </td>
            <td>     </td>
    ...
    <ul id="zdjecia">
        {foreach from=$domyz item=z name=zdjecia}
    ...
    <table>
        ...
        <tr> 
            <td>Adres: </td>
            <td>{$domyp.ulica} {" "} {$domyp.d_nr_budynku}</td>
            <td>     </td>
            <td>Adres:</td>
        ...
        <tr>
            ...
            <td>{$domyp.powierzchnia_dzialki}</td>
            <td>     </td>
            <td>E-mail glowny:</td>
            <td>{$domyp.Mail_g}</td>
        </tr>
        ...
        <tr> 
            <td>Garaz: </td>
            <td>{if $domyp.d_garaz == 1}
                    Tak
                {elseif $domyp.d_garaz == 0}
                    Nie
                {else}
                     -
                {/if} </td>
