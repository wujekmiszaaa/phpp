 ...
 <table class="full">
	...
	{foreach from=$test item=o name=oferty}
        <tr>
            ...
            <td>
                {if !$o.id_oferty}
                    <a href="#" onclick="return dodajDoKoszyka({$o.id_domu}, this)">dodaj do koszyka</a>
                {else}
                    <span style="color: grey">oferta w koszyku</span>
                {/if}
           </td>
           <td>
                <a href="drukujoferte.php?id={$o.id_domu}">drukuj</a>
                <a href="szczdomy.php?id={$o.id_domu}">szczegóły</a>
            </td>
        </tr>
	{/foreach}
    </table>
