 ...
 <table class="full">
	...
	{foreach from=$test item=o name=oferty}
        <tr>
            ...
            <td>
                {if !$o.id_oferty}
                    <a href="#" onclick="return dodajDoKoszyka({$o.id_miesz}, this)">dodaj do koszyka</a>
                {else}
                    <span style="color: grey">oferta w koszyku</span>
                {/if}
           </td>
           <td>
                <a href="drukujoferte.php?id={$o.id_miesz}">drukuj</a>
                <a href="szczmieszkania.php?id={$o.id_miesz}">szczegóły</a>
            </td>
        </tr>
	{/foreach}
    </table>