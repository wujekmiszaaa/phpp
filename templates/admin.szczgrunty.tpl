...
<table> 
{foreach from=$gruntyp item=domyp name=ofertadomu}
<tr>
        ...
        <tr>
            ...
            <td>     </td>
            <td>     </td>
            <td>Dzialka: {$domyp.powierzchnia} m^2</td>
            <td>     </td>
            <td>     </td>
    ...
    <ul id="zdjecia">
        {foreach from=$gruntyz item=z name=zdjecia}
    ...
    <table>
        ...
        <tr> 
            <td>Adres: </td>
            <td>{$domyp.ulica} {" "} {$domyp.parcela}</td>
            <td>     </td>
            <td>Adres:</td>
