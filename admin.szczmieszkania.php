...
$sql="SELECT * FROM (((((((((nieruchomosci n JOIN mieszkania m ON n.id_n = m.id_miesz)
...
$ofertymieszkania = $conn->fetchAll($sql);
$zdjeciamieszkania = $conn->fetchAll($sql2);

//var_dump($ofertymieszkania); die();
$smarty->assign('mieszp', $ofertymieszkania);
$smarty->assign('mieszz', $zdjeciamieszkania);
$smarty->assign('srodek', $smarty->fetch('admin.szczmieszkania.tpl'));
