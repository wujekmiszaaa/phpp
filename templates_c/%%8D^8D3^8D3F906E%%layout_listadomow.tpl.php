<?php /* Smarty version 2.6.26, created on 2012-12-11 15:34:46
         compiled from layout_listadomow.tpl */ ?> 
<?php echo '
...
" width="110" height="110" alt="zdjecie 1" /></a></li>
 ...
 <?php echo ' '; ?>
 <?php echo $this->_tpl_vars['test']['d_nr_budynku']; ?>
</td>
                                </tr>
                                <tr> <td colspan="2" style="background-color: black"></td></tr>
 ...
 <?php echo 'm2'; ?>
                                ...
                                <tr>
                                    <td>Liczba pieter: </td>
                                    <td><?php echo $this->_tpl_vars['test']['d_liczba_pieter']; ?>
</td>
                             </tr>
                                <tr>
                                    <td>Rok budowy: </td>
                                    <td><?php echo $this->_tpl_vars['test']['d_rok']; ?>
</td>
                                </tr>
                                <tr>
                                     <td>Powierzchnia działki: </td>
                                     <td><?php echo $this->_tpl_vars['test']['powierzchnia_dzialki']; ?>
</td>
                                </tr>
                             <tr> 
                                    <td>Ocena stanu domu: </td>
                                    <td><?php echo $this->_tpl_vars['test']['d_stan_domu']; ?>
 <?php echo "/ 5"; ?>
 </td>
                                </tr>
                                <tr> 
 ...
 <?php echo " zł"; ?>
                                ...
                                <tr> 
                                    <td>Garaz: </td>
                                    <td><?php if ($this->_tpl_vars['test']['d_garaz'] == 1): ?>
                                            Tak
                                        <?php elseif ($this->_tpl_vars['test']['d_garaz'] == 0): ?>
                                            Nie
                                        <?php else: ?>
                                            -
                                        <?php endif; ?> </td>
                    ...
                    <form method="POST" action="">
                        ...
                        <a href="drukujoferte.php?id=<?php echo $this->_tpl_vars['test']['id_domu']; ?>
">drukuj</a>
