<?php /* Smarty version 2.6.26, created on 2013-03-30 13:17:55 
         compiled from admin.szczmieszkania.tpl */ ?>
<h1>Szczegoly mieszkania:</h1>
<table>
<?php $_from = $this->_tpl_vars['mieszp']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['ofertamiesz'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['ofertamiesz']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['domyp']):
        $this->_foreach['ofertamiesz']['iteration']++;
?>
<tr>
...
" width="110" height="110" alt="zdjecie 1" /></a></td>
 ...
 m ^2 </td>
    ...
    <ul id="zdjecia">
        <?php $_from = $this->_tpl_vars['mieszz']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['zdjecia'] = array('total' => count($_from), 'iteration' => 0);
...
" width="110" height="110" alt="zdjecie 1" /></a></li>
 ...
 <?php echo ' '; ?>
 <?php echo $this->_tpl_vars['domyp']['m_nr_budynku']; ?>
 <?php echo ' '; ?>
 m. <?php echo ' '; ?>
 ...
 <?php echo 'm2'; ?>
        ...
        <tr>
            <td>Rok budowy: </td>
            <td><?php echo $this->_tpl_vars['domyp']['m_rok']; ?>
</td>
            <td>     </td>
            <td>Tel. komorkowy:</td>
        ...
        <tr>
            <td>Pietro: </td>
            <td><?php echo $this->_tpl_vars['domyp']['m_pietro']; ?>
</td>
            <td>     </td>
            <td>E-mail glowny:</td>
        ...
        <tr> 
            ...
            <td><?php echo $this->_tpl_vars['domyp']['m_liczba_pieter']; ?>
</td>
            <td>    </td>
        ...
        <tr>
            <td>Ocena lokalu: </td>
            <td><?php echo $this->_tpl_vars['domyp']['m_stan_lokalu']; ?>
 <?php echo "/ 5"; ?>
 </td>
        </tr>
        <tr>
            <td>Ocena budynku: </td>
            <td><?php echo $this->_tpl_vars['domyp']['m_stan_budynku']; ?>
 <?php echo "/ 5"; ?>
 </td>
        </tr>
        <tr> 
 ...
 <?php echo " zł"; ?>
        ...
        <tr> 
            <td>Garaz: </td>
            <td><?php if ($this->_tpl_vars['domyp']['m_garaz'] == 1): ?>
                    Tak
                <?php elseif ($this->_tpl_vars['domyp']['m_garaz'] == 0): ?>
                    Nie
                <?php else: ?>
                     -
                <?php endif; ?> </td>
         ...
         <tr> 
            <td>Winda: </td>
            <td><?php if ($this->_tpl_vars['domyp']['m_winda'] == 1): ?>
                    Tak
                <?php elseif ($this->_tpl_vars['domyp']['m_winda'] == 0): ?>
                    Nie
                <?php else: ?>
                     -
                <?php endif; ?> </td>
